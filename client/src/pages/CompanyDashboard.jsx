...
/** Per-organization marketing signal: GA4 / Meta pixel / CAPI token (all
 *  theirs, encrypted) + their personal SE webhook URL + delivery inspector. */
  ...
  return (
    <div className="card">
      ...
      <p style={{ fontSize:12.5, color:'var(--text-3)', margin:'2px 0 14px', maxWidth:720, lineHeight:1.55 }}>
        ...
        every registration is forwarded to <b>your</b> Meta pixel via the Conversions API (hashed, privacy-safe).
        In SE HQ → your API application → Settings: paste the URL under <b>Webhooks URL</b> and enable the
        <b> Registration</b> + <b>Registration Result</b> toggles.
      </p>
      ...
      <WebhookInspector compactTitle="Registrations SportsEngine has sent to your webhook — expand a row for the raw payload." />
    </div>
  );
}
 ...
 * linked to a company via accountKey). Lists the company's organizations
 * with "Enter Data Explorer" buttons and company-scoped user management.
 * No SportsEngine boot runs until an org is entered.
 */
