    ...
    <div ref={wrapRef} style={{ position: 'relative', ...style }}>
      ...
      <div
        ...
        style={{
          ...
          background: '#1e2235', border: `1px solid ${open ? '#3b82f6' : '#2a2d3e'}`,
          borderRadius: 6, padding: '6px 10px', fontSize: 13, cursor: disabled ? 'not-allowed' : 'pointer',
          color: selected ? '#e2e8f0' : '#64748b', userSelect: 'none',
      ...
      >
        ...
        <span style={{ color: '#475569', fontSize: 10, marginLeft: 8, flexShrink: 0 }}>
          {open ? '▲' : '▼'}
        </span>
      </div>
      ...
      {open && (
        <div style={{
          ...
          background: '#13161f', border: '1px solid #2a2d3e', borderRadius: 8,
          ...
          <div style={{ padding: '8px 10px', borderBottom: '1px solid #1e2235' }}>
            <input
              ...
              style={{
                width: '100%', background: '#0d0f17', border: '1px solid #2a2d3e',
                color: '#e2e8f0', borderRadius: 6, padding: '5px 8px', fontSize: 13,
          ...
          >
            {filtered.length === 0 && (
              <div style={{ padding: '12px 14px', color: '#475569', fontSize: 13 }}>No matches</div>
            )}
            {filtered.map((opt, i) => (
              <div
                key={opt.value}
          ...
          {/* Count hint */}
          <div style={{
            padding: '5px 14px', borderTop: '1px solid #1e2235',
